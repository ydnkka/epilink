...
\noindent\textbf{\LARGE S1 Appendix. Detailed derivation and modelling assumptions for the EpiLink compatibility model.}
...
% ---------------------------------------------------------------
\section{Natural-history model}\label{sec:S1_nathistory}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Transmission timing relative to infectiousness onset}\label{sec:S1_toit}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Observation model for testing times}\label{sec:S1_obsmodel}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Scenario space}\label{sec:S1_scenarios}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Temporal compatibility variable}\label{sec:S1_temporal}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Branch length and genetic model}\label{sec:S1_genetic}
% ---------------------------------------------------------------
...
\subsection{Ancestor-descendant branch length}\label{sec:S1_ad_branch}
...
\subsection{Common-ancestor branch length}\label{sec:S1_ca_branch}
...
\subsection{Molecular clock}\label{sec:S1_clock}

Let $\nu$ denote the median substitution rate in substitutions per site per year and $L$ the genome length in sites. The per-genome daily rate is
\[
	\lambda = \frac{\nu L}{365}.
\]
...
\[
	\nu^{(n)} \sim \mathrm{LogNormal}\!\bigl(\log \nu - \tfrac{1}{2}\sigma_\nu^2,\; \sigma_\nu^2\bigr),
	\qquad
	\lambda^{(n)} = \frac{\nu^{(n)} L}{365},
\]
where $\sigma_\nu$ is the clock-relaxation parameter and the log-normal is parameterised so that the \emph{median} equals $\nu$. The baseline evaluation uses $\nu = 10^{-3}$ substitutions per site per year and $\sigma_\nu = 0.33$ for the relaxed-clock variant.

\subsection{Mutation model}\label{sec:S1_mutation}
...
% ---------------------------------------------------------------
\section{Compatibility scoring}\label{sec:S1_scoring}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Modelling assumptions}\label{sec:S1_assumptions}
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
\section{Interpretation and scope}\label{sec:S1_interpretation}
% ---------------------------------------------------------------
...
\begin{thebibliography}{10}
	...
	\bibitem{Hart2021}
	Hart WS, Maini PK, Thompson RN. High infectiousness immediately before COVID-19 symptom onset highlights the importance of continued contact tracing. Elife. 2021 Apr 26;10:e65534.% chktex 13

	\bibitem{Hart2022}
	Hart WS, Miller E, Andrews NJ, Waight P, Maini PK, Funk S, Thompson RN. Generation time of the alpha and delta SARS-CoV-2 variants: an epidemiological analysis. The Lancet Infectious Diseases. 2022 May 1;22(5):603-10.% chktex 8 % chktex 13

	\bibitem{He2020}
	He X, Lau EH, Wu P, Deng X, Wang J, Hao X, Lau YC, Wong JY, Guan Y, Tan X, Mo X. Temporal dynamics in viral shedding and transmissibility of COVID-19. Nature medicine. 2020 May 1;26(5):672-5.% chktex 8 % chktex 13

	\bibitem{Ferretti2020}
	Ferretti L, Wymant C, Kendall M, Zhao L, Nurtay A, Abeler-Dörner L, Parker M, Bonsall D, Fraser C. Quantifying SARS-CoV-2 transmission suggests epidemic control with digital contact tracing. science. 2020 May 8;368(6491):eabb6936.% chktex 12 % chktex 13

	\bibitem{Lauer2020}
	Lauer SA, Grantz KH, Bi Q, Jones FK, Zheng Q, Meredith HR, Azman AS, Reich NG, Lessler J. The incubation period of coronavirus disease 2019 (COVID-19) from publicly reported confirmed cases: estimation and application. Annals of internal medicine. 2020 May 5;172(9):577-82.% chktex 8

	\bibitem{McAloon2020}
	McAloon C, Collins Á, Hunt K, Barber A, Byrne AW, Butler F, Casey M, Griffin J, Lane E, McEvoy D, Wall P. Incubation period of COVID-19: a rapid systematic review and meta-analysis of observational research. BMJ open. 2020 Aug 1;10(8):e039652.
	...
	\bibitem{Lythgoe2021}
	Lythgoe KA, Hall M, Ferretti L, De Cesare M, MacIntyre-Cockett G, Trebes A, Andersson M, Otecko N, Wise EL, Moore N, Lynch J. SARS-CoV-2 within-host diversity and transmission. Science. 2021 Apr 16;372(6539):eabg0821.
